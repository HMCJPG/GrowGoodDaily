...
export default function FoundingPartnersPage() {
  ...
  return (
    <main className="partners-page" id="founding-partners-page">
      ...
      <section className="page-hero" id="partners-hero">
        ...
        <div className="container page-hero__content">
          ...
          <p className="page-hero__subtitle animate-fade-up delay-2">
            Whether you <a href="#donate-section" style={{color: 'inherit', textDecoration: 'underline'}}>donate</a>, <a href="#sponsorship-section" style={{color: 'inherit', textDecoration: 'underline'}}>sponsor</a> or <a href="#volunteer-section" style={{color: 'inherit', textDecoration: 'underline'}}>volunteer</a>, every act of support helps children build healthier financial futures.
          </p>
          <div className="btn-group animate-fade-up delay-3" style={{ marginTop: 'var(--space-md)', justifyContent: 'center' }}>
            <a href="#donate-section" className="btn btn--white">Donate</a>
            <a href="#sponsorship-section" className="btn btn--white">Sponsor</a>
            <a href="#volunteer-section" className="btn btn--white">Volunteer</a>
          </div>
        </div>
      </section>
        ...
        <div className="container container--narrow">
          <AnimatedSection>
            <div className="partners-intro">
              ...
              <p>
                Whether you donate, sponsor, or volunteer, as a founding supporter you will help launch a new model for earlier financial education, stronger families, youth leadership, and broader economic opportunity.
              </p>
            </div>
          </AnimatedSection>
        </div>
      ...
      {/* Donate */}
      <section className="section section--alt donate-section" id="donate-section">
      ...
      <section className="section sponsorship-section" id="sponsorship-section">
        <div className="container">
          <AnimatedSection className="text-center">
            <span className="section__label">Sponsor Opportunities</span>
      ...
      <section className="section section--warm text-center" id="partners-cta">
        <div className="container container--narrow">
          <AnimatedSection>
            <h2 className="section__title">Ready to Be a Founding Supporter?</h2>
